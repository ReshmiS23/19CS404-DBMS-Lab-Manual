...
-- Optional: Turn off variable substitution (useful if data has '&' characters)
SET DEFINE OFF;
...
BEGIN
  ...
  -- Normal logic (will not be reached due to error)
...
RESULT
Thus, the program successfully executed and displayed employee details using a cursor.# Experiment 8: PL/SQL Cursor Programs
